...
(function($) {
    ...
    *************************/
    ...
    $(document).ready(function() {
        $('#hideshowlang').click(function() {
            $('#langlist').slideToggle("100");
        });
    });
...
function l() {
    e("footer nav label").click(function(t) {
        t.preventDefault();
        var i = e(this);
        f.matches || (i.next().hasClass("showing") ? (i.next().removeClass("showing"), i.removeClass("click"), i.next().slideUp(300)) : (i.parents("nav").find(".nav-group .inner").removeClass("showing"), i.parents("nav").find(".nav-group label").removeClass("click"), i.parents("nav").find(".nav-group .inner").slideUp(300), i.next().toggleClass("showing"), i.toggleClass("click"), i.next().slideToggle(300)))
    })
}

$('.dropdown-submenu > a').on("click", function(e) {
    console.log('dropdown-submenu has clicked')
    var submenu = $(this);
...
$('.dropdown').on("hidden.bs.dropdown", function() {
    console.log('dropdown has clicked')
