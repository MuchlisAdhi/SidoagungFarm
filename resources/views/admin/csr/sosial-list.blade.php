        ...
        <div class="box-body">
            <div class="row">
                <div class="col-lg-12" style="margin-bottom: 5px;">
                    <button class="btn btn-sm btn-primary pull-right" id="btnAddSosial">Add Sosial</button>
                </div>
            </div>
            <table id="tblSosial" class="table table-bordered table-hover">
                <thead>
                    <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure to remove Sosial ?</p>
                </div>
