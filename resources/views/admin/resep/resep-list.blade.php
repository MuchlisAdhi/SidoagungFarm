        ...
        <div class="box-body">
            <div class="row">
                <div class="col-lg-12" style="margin-bottom: 5px;">
                    <button class="btn btn-sm btn-primary pull-right" id="btnAddResep">Add Resep</button>
                </div>
            </div>
            <table id="tblResep" class="table table-bordered table-hover">
                <thead>
                    <tr>
